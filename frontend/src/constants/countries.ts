// Liste complète de tous les pays du monde avec leurs codes ISO 3166-1 alpha-2
...
// Fonction pour obtenir le nom d'un pays par son code
export const getCountryName = (code: string): string => {
  const country = countries.find(c => c.code === code)
  return country ? country.name : code
}

// Fonction pour obtenir le code d'un pays par son nom
